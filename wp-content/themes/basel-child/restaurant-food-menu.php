...
<style>
    ...
    #the_head {text-decoration: none !important;font-family: 'Jost', sans-serif !important;font-size: 15px !important;color: orange;}

    #the_description {font-family: 'Jost', sans-serif !important;font-size: 15px !important;text-align: justify !important;padding-right: 10px !important;}

    .down_description {font-family: 'Jost', sans-serif !important;font-size: 15px !important;}

    #the_image {border-radius: 10px !important;height: 50px;width: 70px;}

    .rounded-circle {width: 50%;height: 50%;}

    .main-page-wrapper {background-color: #212121 !important;}

    .qr_code_image {width: 120px !important}

    .inner_div {background-color: white;border-radius: 10px;}

    .main_data {width: 48% !important;box-shadow: rgba(60, 64, 67, 0.01) 5px 1px 2px 3px, rgba(60, 64, 67, 0.08) 2px 3px 5px 1px !important;border-radius: 10px;margin: 10px 5px;}

    .food_menu {box-shadow: rgba(60, 64, 67, 0.01) 5px 1px 2px 3px, rgba(60, 64, 67, 0.08) 2px 3px 5px 1px !important;width: 30% !important;margin-right: 30px !important;}

    .mapouter {position: relative;text-align: right;margin-left: auto !important;margin-right: auto !important;width: 100%;overflow: hidden;}

    .gmap_canvas {overflow: hidden;background: none !important;width: 290px;}

    .gmap_iframe {width: 290px !important;height: auto !important;}

    @media screen and (max-width:319px) {
        .qr_code_image {width: 50px !important;}

        .food_menu {width: 100% !important;box-shadow: unset !important;}

        .main_data {padding-left: 0px !important;width: 100% !important;box-shadow: unset !important;}

        .top_content {width: 100% !important;}

        .down_description1 {width: 100% !important;}

        .down_description2 {width: 100% !important;}

        .mapouter {position: relative;text-align: right;width: 100%;overflow: hidden;}

        .gmap_canvas {background: none !important;width: 100% !important;}

        .gmap_iframe {width: 100% !important;height: auto !important;}
    }
    ...
    @media screen and (min-width:320px) and (max-width: 480px) {
        ...
        .down_description {padding-left: 20px;}

        .main_data {padding-left: 0px !important;box-shadow: unset !important;width: 100% !important}

        .top_content {padding-left: 20px;}

        .down_description1 {width: 50% !important;padding-left: 20px !important;}

        .down_description2 {width: 50% !important;text-align: center;}
    ...
    @media screen and (min-width:481px) and (max-width:768px) {
        ...
        .main_data {width: 98% !important;margin-left: 25px;}

        .food_menu {width: 30% !important;margin-right: 0px !important;box-shadow: unset !important;}

        .down_description {padding-left: 10px;}

        .top_content {padding-left: 10px;}

        .down_description1 {width: 50% !important;padding-left: 20px;}

        .down_description2 {width: 50% !important;text-align: center;}

        .mapouter {position: relative;text-align: right;width: 100% !important;overflow: hidden;}
    ...
    @media screen and (min-width:769px) and (max-width:1024px) {
        .food_menu {box-shadow: rgba(60, 64, 67, 0.01) 5px 1px 2px 3px, rgba(60, 64, 67, 0.08) 2px 3px 5px 1px !important;width: 30% !important;margin-right: 10px !important;}

        .main_data {width: 48% !important;box-shadow: rgba(60, 64, 67, 0.01) 5px 1px 2px 3px, rgba(60, 64, 67, 0.08) 2px 3px 5px 1px !important;border-radius: 10px;margin: 10px 4px;}


        .down_description {padding-left: 10px;width: 100% !important}
