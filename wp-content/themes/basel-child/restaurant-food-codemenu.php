...
<style>
    ...
    .pagination>.page-numbers {border: 2px solid #ddd;padding: 2px 10px;margin: 2px;border-radius: 5px;}
...
?>
<div class="row food_code_menu_inner_div">

    <div class="col-md-4 food_code_menu_food_menu">
    ...
    <div class="col-md-8 main_data_top">
        ...
        ?>
            ...
            foreach ($all_author_categories as $author_category) {
                echo '<div class="food_code_menu_main_data p-2">';
                echo '<div class="food_code_menu_top_content">';
                ...
                if (!empty($foodTypeImage)) {
                    echo ' <img id="food_code_menu_the_image"  src="' . $foodTypeImage['url'] . '" alt="' . $author_category_name . '"> ';
                } else {
                    echo ' <img id="food_code_menu_the_image"  src="' . $default_image . '" alt="' . $author_category_name . '"> ';
                }
                echo '<a id="food_code_menu_the_head" href="">';
                echo $author_category_name;
                echo '</a>';
                echo '<p class="pt-1" id="food_code_menu_the_description">';
                ...
                if ($query->have_posts()) {
                    while ($query->have_posts()) {
                        $query->the_post();
            ?>
                        <div class="row mt-0 pt-0 food_code_menu_down_description">
                            <div class="col-md-6 food_code_menu_down_description1" style="text-transform: capitalize;">
                                <?php the_title(); ?>
                            </div>
                            <div class="col-md-6 food_code_menu_down_description2">
                                <?php
